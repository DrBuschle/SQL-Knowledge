...
SELECT TN2.Column_Name_21, TN1.Column_Name_11 -- here it decides what is left (first written table) and right (second written table)
FROM Table_Name_2 AS TN2
LEFT JOIN Table_Name_1 AS TN1 ON TN1.Matching_Name_X = TN2.Matching_Name_X	-- will give back everything from TN1, but only matching parts of TN2
